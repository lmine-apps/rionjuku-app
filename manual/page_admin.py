...
S5 = (
    ...
    + '<h3>誰がどこまで観たか</h3>'
    + '<p>一覧の<b>「視聴」</b>の列に、その方の進み具合が出ます。'
    '<b>何％・何本中何本</b>と、細いバーで表示されます。</p>'
    + table(["絞り込みボタン", "出てくる人"],
            [["👀 まだ観ていない", "動画が割り当たっているのに、1本も観ていない方"],
             ["🏅 8割以上", "8割以上を観終えている方"]])
    + note("<b>「観た」の数え方</b>"
           "動画を<b>9割まで再生すると自動で</b>視聴済みになります。"
           "ご本人が「□ 視聴済みにする」を押して付け外しすることもできます。"
           "分母は<b>その方に割り当たっている本数</b>（非公開を除く）です。")
    + '<h3>新しい受講生を追加する</h3>'
    + steps([
        "<b>「＋ 閲覧者を追加」を押します</b>",
