...
S4 = (
    ...
    + '<h3>少しだけ戻したいとき</h3>'
    + '<p>動画のすぐ下に <b>「↺ 10秒」「10秒 ↻」</b> のボタンがあります。'
    '聞き逃したところを<b>10秒だけ戻す</b>、先に進めたいときは<b>10秒進む</b>、という使い方ができます。'
    '何度でも押せます。</p>'
    + '<h3>速さを変えたいとき</h3>'
    + '<p>動画の下に <b>「再生速度」</b> が並んでいます。'
    '<b>1.25倍・1.5倍</b>で復習を早く済ませたり、聞き取りにくいときは<b>0.75倍</b>でゆっくり再生できます。'
    '一度選ぶと、次に開く動画にもそのまま引き継がれます。</p>'
    + '<h3>ほかのアプリを使いながら聴く</h3>'
    + '<p>動画の下の <b>「⛶ 小窓にして他のアプリを使う」</b> を押すと、動画が小さな窓になり、'
    'LINEを見たり調べものをしたりしている間も<b>再生が続きます</b>。'
    '<b>先に再生してから</b>押してください。</p>'
    + '<p style="color:var(--ink-soft);font-size:14px">スマートフォンの<b>画面を消すと止まります</b>。'
    'これはiPhone・Androidの決まりで、こちらでは変えられません。</p>'
    + '<h3>観終わったら</h3>'
    + '<p>動画の下の <b>「□ 視聴済みにする」</b> を押しておくと、一覧に ✓ が付きます。'
    '<b>9割ほどご覧いただくと自動で ✓ が付きます。</b>'
    'この記録は凛穏塾側に残りますので、機種を変えても、パソコンで観ても引き継がれます。</p>'
    + '<h3>資料や音声がある回</h3>'
